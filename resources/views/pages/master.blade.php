    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Design and Developed by hmm <a href="" target="_blank" class="pe-1 text-primary text-decoration-underline">Admin</a> Distributed by <a href="">AVENGER</a></p>
        </div>
      </div>
    </div>
  </div>
